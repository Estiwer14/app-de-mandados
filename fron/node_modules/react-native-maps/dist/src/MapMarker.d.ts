...
import { ProviderContext, type MapManagerCommand, type NativeComponent, type UIManagerCommand } from 'react-native-maps/dist/src/decorateMapComponent';
import { type MapMarkerNativeComponentType } from 'react-native-maps/dist/src/MapMarkerNativeComponent';
import type { AppleMarkerPriority } from 'react-native-maps/dist/src/specs/NativeComponentMarker';
import type { CalloutPressEvent, LatLng, MarkerDeselectEvent, MarkerDragEvent, MarkerDragStartEndEvent, MarkerPressEvent, MarkerSelectEvent, Point } from 'react-native-maps/dist/src/sharedTypes';
