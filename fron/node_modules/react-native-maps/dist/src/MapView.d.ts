...
import type { CalloutPressEvent, ClickEvent, Frame, LatLng, MarkerDeselectEvent, MarkerDragEvent, MarkerDragStartEndEvent, MarkerPressEvent, MarkerSelectEvent, Point, Provider, Region, MKPointOfInterestCategoryType } from 'react-native-maps/dist/src/sharedTypes';
import type { ActiveIndoorLevel, Address, BoundingBox, Camera, CameraZoomRange, ChangeEvent, Details, EdgePadding, FitToOptions, IndoorBuilding, KmlMapEvent, LongPressEvent, MapPressEvent, MapStyleElement, MapType, MapTypes, PanDragEvent, PoiClickEvent, SnapshotOptions, UserLocationChangeEvent } from 'react-native-maps/dist/src/MapView.types';
import type { Modify } from 'react-native-maps/dist/src/sharedTypesInternal';
import { type MapViewNativeComponentType } from 'react-native-maps/dist/src/MapViewNativeComponent';
import AnimatedRegion from 'react-native-maps/dist/src/AnimatedRegion';
