...
class Order {
  static async create(orderData) {
    const { client_id, pickup_address, delivery_address, description, price, distance_km, estimated_time_minutes } = orderData;
    const query = `
      INSERT INTO orders (client_id, pickup_address, delivery_address, description, price, distance_km, estimated_time_minutes)
      VALUES ($1, $2, $3, $4, $5, $6, $7)
      RETURNING *
    `;
    const values = [client_id, pickup_address, delivery_address, description, price, distance_km, estimated_time_minutes];
